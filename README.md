...
Hero Image: The hero image represents a visually stunning and captivating design that immediately captures the viewer's attention. It showcases the creativity and artistic flair that can be expected from the designer.

Meet the Team: The images chosen for the "Meet the Team" section reflect our commitment to showcasing the diverse talents and personalities of our design team. Each picture represents an individual team member and conveys their unique qualities and contributions to our collective expertise.
...
- [ImaginecolorPicker](https://imagecolorpicker.com/) was used to choose a colour palette.
...
2. Find the repository for this project, MSP1_CODE_INSTITUTE.
